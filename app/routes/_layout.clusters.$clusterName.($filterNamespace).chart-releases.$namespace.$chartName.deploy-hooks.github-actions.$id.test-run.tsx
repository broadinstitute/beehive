...
export const handle = {
  breadcrumb: (params: Readonly<Params<string>>) => (
    <NavLink
      to={`/clusters/${params.clusterName}/chart-releases/${params.namespace}/${params.chartName}/deploy-hooks/github-actions/${params.id}/test-run`}
    >
      Test
    </NavLink>
  ),
...
export async function action({ request, params }: ActionFunctionArgs) {
  return testGithubActionsDeployHookAction(
    request,
    `/clusters/${params.clusterName}/chart-releases/${params.namespace}/${params.chartName}/deploy-hooks/github-actions/${params.id}/test-run`,
    params.id ?? "",
  );
}
