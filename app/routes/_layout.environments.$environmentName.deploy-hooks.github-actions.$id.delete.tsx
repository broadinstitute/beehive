...
export const handle = {
  breadcrumb: (params: Readonly<Params<string>>) => (
    <NavLink
      to={`/environments/${params.environmentName}/deploy-hooks/github-actions/${params.id}/delete`}
    >
      Delete
    </NavLink>
  ),
...
export const meta: MetaFunction = ({ params }) => [
  {
    title: `${params.environmentName} - Environment - Deploy Hooks - GitHub Actions Hook - Delete`,
  },
];
