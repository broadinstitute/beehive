...
export const handle = {
  breadcrumb: (params: Readonly<Params<string>>) => (
    <NavLink
      to={`/charts/${params.chartName}/chart-releases/${params.chartReleaseName}/deploy-hooks/github-actions/${params.id}/delete`}
    >
      Delete
    </NavLink>
  ),
...
export const meta: V2_MetaFunction = ({ params }) => [
  {
    title: `${params.chartReleaseName} - Chart Instance - Deploy Hooks - GitHub Actions Hook - Delete`,
  },
];
