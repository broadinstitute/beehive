...
export const handle = {
  breadcrumb: (params: Readonly<Params<string>>) => (
    <NavLink
      to={`/environments/${params.environmentName}/chart-releases/${params.chartName}/deploy-hooks/github-actions/${params.id}/test`}
    >
      Test
    </NavLink>
  ),
...
export async function action({ request, params }: ActionFunctionArgs) {
  return testGithubActionsDeployHookAction(
    request,
    `/environments/${params.environmentName}/chart-releases/${params.chartName}/deploy-hooks/github-actions/${params.id}/test`,
    params.id ?? "",
  );
}
