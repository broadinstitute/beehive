...
export const Header: FunctionComponent = () => {
    ...
    return (
        <div className="h-14 bg-white flex space-x-2 shadow-md shrink-0 z-10">
            ...
            {matches
                ...
                .map((match, index) =>
                    <div key={index.toString()} className="flex items-center space-x-2 font-light text-xl">
                        <span>❯</span>
                        {match.handle!.breadcrumb(match.data /* https://github.com/remix-run/remix/discussions/2672 */)}
                    </div>)
            }
        </div>
    )
