    ...
    <div className="shrink-0 grow bg-white overflow-y-auto">
      ...
      >
        <h2 className="text-2xl font-light">
          ...
          <span className="font-medium">{chart.name}</span> Helm Chart?
        </h2>
        <p>
          This will soft-delete it from DevOps's Sherlock source-of-truth
          service. Information about the chart, including chart versions and app
          versions, will become inaccessible.{" "}
          <b>
        ...
        <p>
          This will not delete it from the Helm Repo where tar-balled artifacts
          are stored, or from the Git repo where the source files are stored.
        </p>
        <p>
          After deletion, the name of the chart will remain reserved in Sherlock
          forever. You will not be able to create a new chart with the same
          name.
        </p>
      </DeletePanel>
    </div>
