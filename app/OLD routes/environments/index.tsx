...
const EnvironmentsIndexRoute: FunctionComponent = () => (
  <PlaceholderPanel title="Environments">
    ...
    <p>
      <b>Template</b> environments exist in our configuration files, but not our
      actual infrastructure. They're one half of what makes BEEs, our ephemeral
      Branch Engineering Environments.
    </p>
    <p>
      <b>Dynamic</b> environments exist in our infrastructure, but not
      individually in our configuration. Dynamic environments borrow their
      configuration from a template—you can say they're instances of a template.
      They're the second half of BEEs, so when someone says they're going to
      start up a BEE, they're creating a new dynamic environment.
    </p>
  </PlaceholderPanel>
);
