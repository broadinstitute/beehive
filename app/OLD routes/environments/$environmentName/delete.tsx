  ...
  return (
    <div className="shrink-0 grow bg-white overflow-y-auto">
      <DeletePanel
        ...
        deleteGuard={environment.lifecycle !== "dynamic"}
      ...
      >
        ...
        <p>
          This will soft-delete it from DevOps's Sherlock source-of-truth
          service.
        </p>
        {environment.lifecycle === "dynamic" && (
          <p>
            Since this environment is dynamic, that will cause it to become
            unrendered by Thelma, meaning that the entire deployment will get
            wiped from our infrastructure.
          </p>
        )}
        {environment.lifecycle === "template" && (
          <p>
            Since this environment is a template, any BEEs based on it will
            continue functioning but no new ones will be able to be created.
          </p>
        )}
        {environment.lifecycle === "static" && (
          <p>
            Since this environment is static, all Kubernetes resources will
            cease being rendered by Thelma. There are protections in place that
            will prevent immediate deletion, and Terraform resources like
            databases will be unaffected. You should contact DevOps before
            proceeding.
          </p>
        )}
        <p>
          This will not delete any associated configuration from our Helm values
          in{" "}
          <a
        ...
        <p>
          ...
          Sherlock forever. You will not be able to create a new environment
          with the same name.
        </p>
